...
function(rapids_cpm_package_details_internal package_name version_var url_var tag_var subdir_var
  ...
  if(NOT DEFINED rapids-cmake-rocm-org)
    if(NOT "$ENV{RAPIDS_CMAKE_ROCM_ORG}" STREQUAL "")
      ...
      message(DEBUG "rapids_cpm_package_details_internal: RAPIDS_CMAKE_ROCM_ORG=${rapids-cmake-rocm-org}")
    else()
      set(rapids-cmake-rocm-org ROCm)
      message(DEBUG "rapids_cpm_package_details_internal: Using default RAPIDS_CMAKE_ROCM_ORG=${rapids-cmake-rocm-org}")
    endif()
  endif()
  ...
  if(NOT DEFINED rapids-cmake-rocm-ds-org)
    if(NOT "$ENV{RAPIDS_CMAKE_ROCM_DS_ORG}" STREQUAL "")
      ...
      message(DEBUG "rapids_cpm_package_details_internal: RAPIDS_CMAKE_ROCM_DS_ORG=${rapids-cmake-rocm-ds-org}")
    else()
      set(rapids-cmake-rocm-ds-org ROCm-DS)
      message(DEBUG "rapids_cpm_package_details_internal: Using default RAPIDS_CMAKE_ROCM_DS_ORG=${rapids-cmake-rocm-ds-org}")
    endif()
  endif()
